...
curl -sL https://github.com/theodoreschen/ng-teddystrations-game/releases/download/1.0/ng-teddystrations-game.tgz --output ng-teddystrations-game.tgz
...
curl -sL https://github.com/theodoreschen/ng-teddystrations-players/releases/download/1.0/ng-teddystrations-players.tgz --output ng-teddystrations-players.tgz
